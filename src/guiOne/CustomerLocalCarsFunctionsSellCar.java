...
public class CustomerLocalCarsFunctionsSellCar extends JPanel {

    JButton jButtonBack, jButtonPlaceCar, jButtonSearchSellToUs;

    CustomerLocalCarsFunctionsSellCar() {
        setVisible(true);
        ...
        jButtonSearchSellToUs.addActionListener(e -> {
            setVisible(false);
            customerLocalSellCarToUs.setVisible(true);
        });

        jButtonPlaceCar.addActionListener(e -> {
            setVisible(false);
            customerLocalPlaceCarSell.setVisible(true);
        });
    }
