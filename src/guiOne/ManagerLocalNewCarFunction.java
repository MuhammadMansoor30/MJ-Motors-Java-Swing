...
public class ManagerLocalNewCarFunction extends JPanel {
    ...
    ManagerLocalNewCarFunction() {
        ...
        jButtonLocalNewAdd.addActionListener(e -> {
            setVisible(false);
            managerLocalNewAddCar.setVisible(true);


        });
        jButtonLocalNewUpdate.addActionListener(e -> {
            setVisible(false);
            managerLocalNewUpdateCar.setVisible(true);

        });
        jButtonLocalNewRemove.addActionListener(e -> {
            setVisible(false);
            managerLocalNewRemoveCar.setVisible(true);
