...
public class CustomerImportedPurchaseCarFunctions extends JPanel {
    JButton jButtonCheckNewCars, jButtonCheckOldCars, jButtonBack;

    CustomerImportedPurchaseCarFunctions() {
        setVisible(true);
        ...
        jButtonCheckNewCars.addActionListener(e -> {
            setVisible(false);
            customerImportedNewCarPurchase.setVisible(true);

        });
        jButtonCheckOldCars.addActionListener(e -> {
            setVisible(false);
            customerImportedOldCarPurchase.setVisible(true);
        });
